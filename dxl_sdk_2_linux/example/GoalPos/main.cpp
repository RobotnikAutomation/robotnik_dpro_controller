...
int main()
{
    ...
    int GoalPos = 0; // 3-o-clock position for 42-series
    ...
    DXL.WriteByte(11, TORQUE_ENABLE, 1, 0);
    usleep(CONTROL_PERIOD*100);
    // set initial Goal Position to 0
    DXL.WriteDWord(11, GOAL_POSITION, 0, 0);
    ...
    while(1)
    {
        ...
        if(_getch() == 0x1b)
            break;
        DXL.WriteDWord(11, GOAL_POSITION, GoalPos, 0);   //move to 9-o-clock position     
	printf( "moving...\n" );	
	usleep(CONTROL_PERIOD*500);
